...
<div className="flex grid grid-auto-rows dark:bg-black w-full h-full min-h-full relative overflow-x-hidden bg-[#02082c]" style={{minHeight: '100%'}}> 
  <style>
      ...
      {Data ?
          <div className="grid grid-cols-1 grid-rows-2 place-items-center mt-18 md:mt-8 text-gray-200 min-w-full min-h-full static gap-8 pb-24">
            <div className="grid gap-8 h-full static place-items-center w-full px-4">
              ...
              <div className="grid w-full max-w-[800px] h-[75%] md:h-auto place-items-center overflow-y-auto mt-4 md:mt-20 p-4 dot-scrollbar static" style={{scrollbarWidth: 'thin', scrollbarColor: 'gray transparent'}}>
                ...
                {Shapes ?
                  <div className="grid grid-rows-5 grid-cols-1 mt-8 md:mt-24 w-full h-512 max-w-[700px] p-2 md:p-4 self-start gap-8 md:gap-32 static">
...
{Data ?
  <div>
          ...
          <div className={!ShowCode ? "text-white text-xl hover:font-bold bottom-4 right-48 md:bottom-6 md:right-192 ml-auto absolute hover:text-gray-300 cursor-pointer" : "text-xl font-bold bottom-4 right-48 md:bottom-6 md:right-192 ml-auto absolute text-gray-300 cursor-pointer"} onMouseEnter={e=>setShowCode(true)} onClick={e=>setShowCode(false)}>
            CODE
          </div>
          <div className="text-white text-xl hover:font-bold bottom-4 left-48 md:bottom-6 md:right-12 md:left-auto ml-auto absolute hover:text-gray-300 cursor-pointer" onMouseEnter={e=>setShowExample(true)} onMouseLeave={e=>setShowExample(false)}>
            EXAMPLE ONLY
          </div>
          {ShowCode && !ShowExample?
            <div className="text-white p-4 py-5 bottom-16 right-auto md:bottom-18 md:right-192 ml-auto absolute w-auto md:w-128 h-auto rounded-lg bg-blue-600">
          ...
          : null}
          {ShowExample && !ShowCode?
            <div className="text-white p-4 bottom-16 left-auto md:bottom-18 md:right-12 md:left-auto ml-auto absolute w-auto md:w-128 h-auto rounded-lg bg-blue-600">
