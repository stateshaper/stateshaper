...
{Data ?
  <div>
          ...
          <div className={!ShowCode ? "text-white text-xl hover:font-bold bottom-4 right-36 md:bottom-6 md:right-192 ml-auto absolute hover:text-gray-300 cursor-pointer" : "text-xl font-bold bottom-4 right-4 md:bottom-6 md:right-192 ml-auto absolute text-gray-300 cursor-pointer"} onMouseEnter={e=>setShowCode(true)} onClick={e=>setShowCode(false)}>
            CODE
          </div>
          <div className="text-white text-xl hover:font-bold bottom-4 left-36 md:bottom-6 md:right-12 md:left-auto ml-auto absolute hover:text-gray-300 cursor-pointer" onMouseEnter={e=>setShowExample(true)} onMouseLeave={e=>setShowExample(false)}>
            EXAMPLE ONLY
          </div>
          {ShowCode ?
